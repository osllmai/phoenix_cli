    ...
    crow::response update_profile(const crow::request &req) {
        ...
        try {
            ...
            if (verify_jwt(auth_header)) {
                ...
                user_profile.anthropic_api_key = request_body.value("anthropic_api_key",
                                                                    user_profile.anthropic_api_key);
                ...
                user_profile.perplexity_api_key = request_body.value("perplexity_api_key",
                                                                     user_profile.perplexity_api_key);
    ...
    crow::response get_by_user_id(const crow::request &req) {
        ...
        try {
            ...
            if (verify_jwt(auth_header)) {
                ...
                UserProfile get_user_profile = models::Profile::get_by_id(user_id);
